...
const filteredNotes = useMemo(() => {
    ...
    <Row className="align-items-center mb-4">
        ...
        <EditTagsModal deleteTag={deleteTag} updateTag={updateTag} show={editTagsModalIsOpen} handleClose={() => setEditTagsModalIsOpen(false)} availableTags={availableTags}></EditTagsModal>
                ...
                <Stack gap={2}>
                    {availableTags.map (tag => (
                        <Row key={tag.id}>
                            ...
                            <Col xs="auto">
                                <Button onClick = {() => deleteTag}variant="outline-danger">&times;</Button>
                            </Col>
